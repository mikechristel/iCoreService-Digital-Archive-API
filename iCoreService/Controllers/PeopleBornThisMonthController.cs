...
namespace iCoreService.Controllers
{
    ...
    /// </summary>
    public class PeopleBornThisMonthController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> GetPeopleBornThisMonth(int? pageSize = 20,
                                                                     int? currentPage = 1,
                                                                     string genderFacet = "",
                                                                     string yearFacet = "",
                                                                     string makerFacet = "",
                                                                     ...
                                                                     string dateTodayFacet = "")
        {
            try
            {
                var results = await this.azureSearch.GetPeopleBornThisMonth(
