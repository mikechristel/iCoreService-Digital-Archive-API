...
{
    /// <summary>
    /// Provides a list of biographies (people) born this week.
    /// </summary>
    public class PeopleBornThisWeekController : ApiController
    {
        private AzureSearch azureSearch = new AzureSearch();

        /// <summary>
        /// Retrieve a list of people born this week with optional filtering.
        /// </summary>
        ...
        public async Task<HttpResponseMessage> GetPeopleBornThisWeek(int? pageSize = 20,
                                                                     int? currentPage = 1,
                                                                     string genderFacet = "",
                                                                     string yearFacet = "",
                                                                     string makerFacet = "",
                                                                     ...
                                                                     string dateTodayFacet = "")
        {
            try
            {
                var results = await this.azureSearch.GetPeopleBornThisWeek(
